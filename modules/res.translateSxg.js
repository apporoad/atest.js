...
exports.getLustForOthers= async (obj,options) => { 
    options = options || {}
    options.resData = options.resData || null 
    options.context = options.context || {}
    options.options = options.options || {}
    if(utils.Type.isAsyncFunction(obj)){
        return  await obj( options.resData,options.context,options.options )
    }else if(utils.Type.isFunction(obj)){
        return obj( options.resData,options.context,options.options)
